...
class ChatCompletionRequest(OpenAIBaseModel):
    ...
    token_pruning: float | None = Field(
        ...
        description=(
            ...
            "Qwen2.5-VL; the latter requires serving with "
            "--enable-hiprune). "
    ...
    token_pruning_method: str | None = Field(
        ...
        description=(
            ...
            "'hydart', 'hiprune_pp', 'dart', 'nprune', 'checkered', "
            "'anchorprune' or 'random'. Per-request — the same running "
            "server can serve different methods. Shorthand for "
